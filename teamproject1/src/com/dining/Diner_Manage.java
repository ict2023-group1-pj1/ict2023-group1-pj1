...
//	private JFrame frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Diner_Manage window = new Diner_Manage();
	...
	private void initialize() {
		...
		jPanel_admin.setBounds(100, 100, 1200, 850);
		...
		backbutton.setIcon(new ImageIcon(Diner_Manage.class.getResource("/image/backbutton.png")));
		...
		tabbedPane.addTab("", new ImageIcon(Diner_Manage.class.getResource("/image/DinerRevise.png")), panel_2, null);
		...
		tabbedPane.addTab("", new ImageIcon(Diner_Manage.class.getResource("/image/DinerNew.png")), panel_1, "");
...
//		panel_2.add(table);
		...
		lblNewLabel_2.setBounds(287, 31, 220, 51);
		jPanel_admin.add(lblNewLabel_2);
		
		JLabel lblNewLabel_2_1 = new JLabel("음식점 신규등록");
		...
		JLabel lblNewLabel_2_1_1 = new JLabel("음식점 신규등록");
		...
		lblNewLabel_2_1_1.setBounds(736, 41, 175, 30);
		jPanel_admin.add(lblNewLabel_2_1_1);
		
		JLabel lblNewLabel_2_1_1_1 = new JLabel("등록된 음식점");
		lblNewLabel_2_1_1_1.setForeground(new Color(65, 105, 225));
		lblNewLabel_2_1_1_1.setFont(new Font("Sandoll 삼립호빵체 TTF Basic", Font.PLAIN, 30));
		lblNewLabel_2_1_1_1.setBounds(544, 41, 160, 30);
		jPanel_admin.add(lblNewLabel_2_1_1_1);
	}
}
