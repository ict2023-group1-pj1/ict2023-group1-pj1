...
public class admin02_Final extends JPanel {
	...
	public admin02_Final() {
		...
		backbutton.setIcon(new ImageIcon(admin02_Final.class.getResource("/image/backbutton.png")));
		...
		tabbedPane.setBounds(36, 194, 1120, 650);
		add(tabbedPane);
		...
		tabbedPane.addTab("", new ImageIcon(admin02_Final.class.getResource("/image/RegisteredDiner.png")), panel, "");
		tabbedPane.setBackgroundAt(7, Color.RED);
		
		JPanel panel_1 = new JPanel();
		panel_1.setBackground(new Color(213, 221, 255));
		tabbedPane.addTab("", new ImageIcon(admin02_Final.class.getResource("/image/DinerNew.png")), panel_1, null);
		...
		tabbedPane.addTab("", new ImageIcon(admin02_Final.class.getResource("/image/DinerRevise.png")), panel_2, null);
		...
		JButton btnNewButton_21 = new JButton("등  록");
		btnNewButton_21.setForeground(new Color(255, 240, 245));
		btnNewButton_21.setFont(new Font("Sandoll 삼립호빵체 TTF Basic", Font.PLAIN, 25));
		btnNewButton_21.setBorderPainted(false);
		btnNewButton_21.setBackground(new Color(65, 105, 255));
		btnNewButton_21.setBounds(171, 480, 125, 34);
...
//		panel_3_1.setBounds(467, 75, 580, 381);
